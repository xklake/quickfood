...
$this->title = Module::t('blog', 'Catalogs');
...
<div class="blog-catalog-index">
    ...
    <p>
        <?= Html::a(Module::t('blog', 'Create ') . Module::t('blog', 'Catalog'), ['create'], ['class' => 'btn btn-success']) ?>
    </p>
    ...
    <table class="table table-striped table-bordered">
        ...
        <tr data-key="1">
            ...
            <td>
                <?php
                if ($item['status'] === Status::STATUS_ACTIVE) {
                    $status = Module::t('blog', 'Active');
                    $class = 'label-success';
                } elseif ($item['status'] === Status::STATUS_INACTIVE) {
                    $status = Module::t('blog', 'Inactive');
                    $class = 'label-warning';
                } else {
                    $status = Module::t('blog', 'Deleted');
                    $class = 'label-danger';
                }
